---
title: How It Works
description: End-to-end overview of the Ammo Exchange protocol.
---

## The Flow

Ammo Exchange connects the physical ammunition market to the blockchain through a simple cycle:
...
Every token in circulation is backed 1:1 by physical ammunition stored in a secure warehouse facility. When you mint tokens, Ammo Exchange purchases the corresponding ammunition to maintain full backing. When you redeem, ammunition is pulled from the warehouse and shipped to you.
