...
6. **Fulfillment** — AmmoMarkets reviews and ships your order via **UPS Ground**. Age verification happens at delivery — the recipient must be present and meet the federal age requirement (**21+** for 9mm, **18+** for 5.56 NATO). Track your order in [Portfolio](/guides/portfolio).
