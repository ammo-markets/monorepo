...
5. **Enter shipping address** — Provide your U.S. delivery address. It's validated against the USPS database. Only the **48 contiguous states** are supported — see [State Restrictions](/regulatory/state-restrictions) for details. If you've redeemed before, your last address is pre-filled.

6. **Fulfillment** — Ammo Exchange reviews and ships your order via **UPS Ground**. Age verification happens at delivery — the recipient must be present and meet the federal age requirement (**21+** for 9mm, **18+** for 5.56 NATO). Track your order in [Portfolio](/guides/portfolio).
