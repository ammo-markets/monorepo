  ...
  return (
    <SlideLayout className="items-center justify-center text-center">
      ...
      >
        ...
        >
          Strategic Liquidity Partnership
        </motion.p>
        <motion.p
          variants={fadeUp}
          className="mt-4 max-w-2xl text-sm text-text-muted sm:text-base lg:text-lg"
        >
          Bootstrap the first onchain ammunition commodity on Avalanche.
        </motion.p>
      </motion.div>
    </SlideLayout>
  );
