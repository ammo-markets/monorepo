...
|---|-------|--------|----------|
| 1 | Stats worker recomputes per-caliber protocol stats every 15 minutes | ✓ VERIFIED | STATS_INTERVAL_MS = 15 * 60 * 1000 in constants.ts, setInterval(computeStats, STATS_INTERVAL_MS) in index.ts |
