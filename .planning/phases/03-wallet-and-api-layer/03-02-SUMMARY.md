...
subsystem: api
tags:
  [next.js, route-handlers, viem, prisma, zod, multicall, bigint-serialization]
...
tech-stack:
  added:
    [
      "@prisma/client@7.3.0 (explicit dependency for Prisma 7 runtime resolution)",
    ]
  patterns:
    [
      "readContract over multicall for mapped arrays (avoids TypeScript tuple inference issues)",
      "BigInt(0) over 0n literal (ES2017 target compatibility)",
      "serverExternalPackages for Prisma WASM modules",
    ]
