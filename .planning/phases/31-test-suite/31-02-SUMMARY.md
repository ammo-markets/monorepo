...
tech-stack:
  added: [vitest]
  patterns: [vi.mock for module-level import interception, mock session/prisma factories, NextRequest nextUrl shim]
...
- **Files modified:** apps/web/app/api/__tests__/auth.test.ts
...
- **Files modified:** apps/web/app/api/__tests__/helpers.ts
